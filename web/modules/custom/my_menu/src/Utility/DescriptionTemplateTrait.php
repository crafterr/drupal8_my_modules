...
namespace Drupal\my_menu\Utility;
...
trait DescriptionTemplateTrait {
  ...
  protected function getSubscriptionTemplatePath() {
    return drupal_get_path('module', $this->getModuleName()) . "/templates/subscription.html.twig";
  }
